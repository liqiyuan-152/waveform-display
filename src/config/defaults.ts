...
export const defaultOptions = {
  ...
  padding: { top: 42, right: 28, bottom: 58, left: 72 },
  frame: {
    visible: true,
  ...
  xAxis: {
    visible: true, min: undefined, max: undefined, tickCount: 8, tickSize: 6, tickPadding: 6, tickFormat: '',
  ...
  yAxis: {
    visible: true, min: undefined, max: undefined, tickCount: 6, tickSize: 6, tickPadding: 6, tickFormat: '',
    color: '#64748b', width: 1, fontSize: 11, fontColor: '#475569', label: '', unit: '',
